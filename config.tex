...
\def\elementAA{\textbf{\author} \\ MatrNr: 01126686}

\def\elementB{Submitted at}
\def\elementBB{\textbf{Institute for Machine Learning}}

\def\elementC{First Supervisor / First Evaluator}
...
\def\title{Generative Models in Drug Discovery: \Huge Advancing Evaluation and Retrosynthesis Prediction}
% \def\title{Generative Models for Molecules: \Huge Advancing Evaluation and Retrosynthesis Prediction}
