...
% A general paragraph. What is CADD
\Ac{CADD} involves leveraging computational tools to model chemical and biological systems,
...
% One specific paragraph about molecular property and activity prediction
...
In contrast, ligand-based methods employ quantitative structure-activity relationship (QSAR) models, often employing
...
\Cref{fig:molecular-graph}A. The most comprehensive representation is the quantum mechanical
...
\textbf{Generative flows} \citep{rezendeVariationalInferenceNormalizing2015} transform a simple
...
Goal-directed generators address this limitation of \ac{VS} by conducting a directed search in
...
\Cref{fig:goal-directed-generation}. This is achieved by an iterative process in which a model
...
A variety of approaches exists to assess how well a model can reproduce the training set in
...
When ML models are used as scoring functions in goal-directed optimization, one issue that arises is the potential lack
