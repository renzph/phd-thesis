...
\begin{itemize}
    ...
    \item \textbf{Make:} The designed molecules are then synthesized and prepared for testing. This
          step requires a synthesis plan that outlines the steps needed to make the molecule.
...
\begin{itemize}
    ...
    \item \textbf{Computer-aided synthesis planning}: A computational approach designed to predict and optimize synthetic routes for
          target molecules, facilitating the efficient synthesis of novel compounds.
\end{itemize}
...
\begin{figure}[t]
    ...
    \caption{Different approaches to generate molecules in drug discovery. \textbf{A:} Graph-based
        ...
        tokens, relying on \acp{RNN} or Transformers \textbf{C:} Matrix-based models generate an
...
of many generative models for molecules
...
shortcomings have led to a lack of informative evaluations of diversity in goal-directed generation.
